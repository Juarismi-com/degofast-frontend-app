   ...
   <div>
      ...
      <div class="pb-4">
         ...
         <div class="flex">
            <div class="flex items-center h-5">
               <input id="contribuyenteCliente" aria-describedby="helper-checkbox-text"
                  v-model="formData.cliente.contribuyente" type="checkbox" value=""
                  class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
            </div>
            <div class="ms-2 text-sm">
               <label for="contribuyenteCliente" class="font-medium text-gray-900 dark:text-gray-300">
         ...
         <div>
            <hr class="my-4" />
            <div v-if="formData.cliente.contribuyente" class="grid grid-cols-4 gap-4">
               <div>
                  <label for="ciCliente">RUC:</label>
                  <input type="text" v-model="formData.cliente.ruc" id="ciCliente" :class="INPUT_CLASS.sm"
                     class="mr-2" />
               </div>
               <div>
                  <button type="button"
      ...
      <div class="grid grid-cols-4 gap-4 pb-4">
         <div>
            ...
            <input type="text" v-model="formData.cliente.razonSocial" id="nombreCliente" :class="INPUT_CLASS.sm" />
         </div>
         <div>
            <label for="telefonoCliente">Teléfono:</label>
            <input type="text" v-model="formData.cliente.telefono" id="telefonoCliente" :class="INPUT_CLASS.sm" />
         </div>
         <div>
            <label for="emailCliente">Email:</label>
            <input type="text" v-model="formData.cliente.email" id="emailCliente" :class="INPUT_CLASS.sm" />
         </div>
         <div>
            <label for="direccionCliente">Dirección:</label>
            <input type="text" v-model="formData.cliente.direccion" id="direccionCliente" :class="INPUT_CLASS.sm" />
         </div>
         <div v-if="formData.cliente.contribuyente">
            <label for="tipoContribuyenteCliente">Tipo de contribuyente:</label>
            <select v-model="formData.cliente.tipoContribuyente" id="tipoContribuyenteCliente" :class="INPUT_CLASS.sm">
      ...
      <div class="grid grid-cols-4 gap-4 pb-4" v-if="!formData.cliente.contribuyente">
         <div>
            <label for="tipoOperacionCliente">Tipo de operación:</label>
            <select v-model="formData.cliente.tipoOperacion" id="tipoOperacionCliente" :class="INPUT_CLASS.sm">
         ...
         <div>
            ...
            <select v-model="formData.cliente.documentoTipo" id="tipoDocumentoCliente" :class="INPUT_CLASS.sm">
         ...
         <div>
            ...
            <input type="text" v-model="formData.cliente.documentoNumero" id="clienteNumeroDocumento"
               :class="INPUT_CLASS.sm" class="mr-2" :disabled="formData.cliente.contribuyente ||
