export const APP_NAME = "boleta.digital";
export const APP_LOGO_PATH = "";

export const HOME_PAGE_PATH = "/dashboard";

export const INPUT_CLASS = {
   basic: "bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5",
   sm: "block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500",
};

export const BTN_CLASS = {
   lila_basic:
      "text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2 text-center",
   gray_basic:
...
export const useConfig = () => {
   ...
   return {
      ...
      DEGOFAST_FILE_GENERATOR: config.DEGOFAST_FILE_GENERATOR,
   };
};
